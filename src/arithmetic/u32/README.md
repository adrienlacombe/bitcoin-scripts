...
| `u32_nor(0, 1, 3)` (table excluded) | <!-- metric:u32_nor -->346<!-- /metric:u32_nor --> bytes | 0 bytes | <!-- metric:u32_nor_stack -->273<!-- /metric:u32_nor_stack --> items, including table; <!-- metric:u32_nor_opcodes -->0<!-- /metric:u32_nor_opcodes --> static non-push opcodes |
