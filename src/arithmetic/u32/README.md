...
| `u32_xnor(0, 1, 3)` (table excluded) | <!-- metric:u32_xnor -->0<!-- /metric:u32_xnor --> bytes | 0 bytes | <!-- metric:u32_xnor_stack -->0<!-- /metric:u32_xnor_stack --> items, including table; <!-- metric:u32_xnor_opcodes -->0<!-- /metric:u32_xnor_opcodes --> static non-push opcodes |
