...
| `u32_nand(0, 1, 3)` (table excluded) | <!-- metric:u32_nand -->192<!-- /metric:u32_nand --> bytes | 0 bytes | <!-- metric:u32_nand_stack -->273<!-- /metric:u32_nand_stack --> items, including table; <!-- metric:u32_nand_opcodes -->0<!-- /metric:u32_nand_opcodes --> static non-push opcodes |
