...
| Checked u4 square query modulo 16 | <!-- metric:u4_square_mod16 -->0<!-- /metric:u4_square_mod16 --> bytes | <!-- metric:u4_square_mod16_stack -->0<!-- /metric:u4_square_mod16_stack --> items | <!-- metric:u4_square_mod16_opcodes -->0<!-- /metric:u4_square_mod16_opcodes --> |

The square row measures only the checked reusable query; its generated
16-item table setup is <!-- metric:u4_square_mod16_table -->0<!-- /metric:u4_square_mod16_table --> bytes and can be shared across square queries. The representative witness is
