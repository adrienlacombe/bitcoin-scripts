...
standalone batch under the strict local stack limit. `lowbit.rs` and `parity.rs`
exhaustively check their 16-value lookup domains, reject malformed inputs and
invalid batch sizes, and measure representative strict batches.
