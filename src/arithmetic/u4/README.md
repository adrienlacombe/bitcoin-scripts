...
| Checked nondecreasing batch, 32 nibbles | <!-- metric:u4_nondecreasing_batch32 -->478<!-- /metric:u4_nondecreasing_batch32 --> bytes | <!-- metric:u4_nondecreasing_batch32_stack -->35<!-- /metric:u4_nondecreasing_batch32_stack --> items | <!-- metric:u4_nondecreasing_batch32_opcodes -->460<!-- /metric:u4_nondecreasing_batch32_opcodes --> |
